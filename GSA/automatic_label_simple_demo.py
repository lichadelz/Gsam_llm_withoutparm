...
sys.path.append('/home/lichalab/GSam_llm/GSA/recognize-anything')
...
GROUNDING_DINO_CHECKPOINT_PATH = "./GSA/groundingdino_swint_ogc.pth"

SAM_ENCODER_VERSION = "vit_h"
SAM_CHECKPOINT_PATH = "./GSA/sam_vit_h_4b8939.pth"

TAG2TEXT_CHECKPOINT_PATH = "./GSA/tag2text_swin_14m.pth"
RAM_CHECKPOINT_PATH = "./GSA//ram_swin_large_14m.pth"
# RAM_CHECKPOINT_PATH = "./GSA/ram_plus_swin_large_14m.pth"


def auto_label(num_jpg):
    # Hyper-Params
    ...
    cv2.imwrite("/home/lichalab/GSam_llm/data_label/detect_image.jpg", annotated_frame)
    ...
    cv2.imwrite("/home/lichalab/GSam_llm/data_label/seg_image.jpg", annotated_image)
